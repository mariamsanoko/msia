...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../../../nuxt/dist/app/plugins/router.js")> &
  ...
  InjectionType<typeof import("../../../../@nuxtjs/supabase/dist/runtime/plugins/auth-redirect.js")>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'supabase' | 'supabase' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'auth-redirect'
  }
}
