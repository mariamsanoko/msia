import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, createElementBlock, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext, ref } from 'vue';
import { h as hasProtocol, l as isScriptProtocol, i as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, c as createError$1, o as isEqual, p as getHeader, q as executeAsync, t as stringifyParsedURL, v as stringifyQuery, x as parseQuery, y as toRouteMatcher, z as createRouter, A as defu, B as setCookie, e as destr, C as klona, D as parse, E as getRequestHeader, F as isEqual$1, G as getCookie, H as deleteCookie } from '../nitro/nitro.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b1d6e7b8"]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-9qF7Gt8C.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CZBUTooC.mjs'));
